...
import { TextField, Container, Box, Typography, Button, ImageListItem, ImageListItemBar, Divider } from '@mui/material';
...
const HomePage = () => {
  ...
  return (
    <Container style={{ maxWidth: '80%', textAlign: 'center', marginTop: '50px', alignItems: 'center' }}>
      {/*box for top images and two bottons */}
      <Box style={{ marginButtom: '40px', height:'30%'}}>
        <Box style={{width:'100%', display:'grid', gridTemplateColumns:'70% 30%'}}>
          <Box style={{ width: '70%', alignItems: 'center', mariginLeft: '400px', maxHeight: "300px"}}>
              <SimpleSlider />  
          </Box>
          <Box style={{ width: '30%', marginTop: '50px'}}>
              <Button
                ...
                <FaHandHoldingHeart style={{ width: "40%", height: "50%"}}>
                </FaHandHoldingHeart> 
                <h3>Donate Now</h3>
              </Button>
              <Button
                ...
                to="/fundraise"
                style={{ marginTop: '30px',  width: "300%", height: "40%"}}>
                <FaRegPenToSquare style={{ width: "40%", height: "50%"}}>
                </FaRegPenToSquare> 
                <h3>Fundraise Now</h3>
              </Button>
          </Box>
      ...
      <Box style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px', marginTop: '30px' }}>
        {fundList.map((item) => (
          <ImageListItem key={item.id}>
            ...
            <ImageListItemBar
              ...
              position="below"
              actionIcon={
                <Button variant="contained" style={{ width: '100%', marginTop: '30px' }} onClick={() => { navigate('/donate/' + item.fundID) }}> Donation</Button>
              }
            />
          </ImageListItem>
        ))}
